...
BOOST_AUTO_TEST_CASE(dummyTest) {
	...
	PBQPGraph<unsigned long int>* secondGraph = serial.loadFromFile("testgraph.json");
...
BOOST_AUTO_TEST_CASE(dummyTest2) {
	...
	PBQPGraph<unsigned short int>* secondGraph = serial.loadFromFile("testgraph2.json");
	BOOST_TEST_MESSAGE(secondGraph->getEdgeCount());
}
...
BOOST_AUTO_TEST_CASE(dummyTest3) {
	...
	PBQPGraph<unsigned char>* secondGraph = serial.loadFromFile("testgraph3.json");
	BOOST_TEST_MESSAGE(secondGraph->getEdgeCount());
}
